...
class Controller:
    ...
    def initialize(self) -> None:
        ...
        if self._load_strategies_data_from_files:
            ...
            if len(self._btc_strategy.candles) <= self._btc_strategy.window_size and len(
                    self._eth_strategy.candles) <= self._eth_strategy.window_size:
                self.__init_candles()
        else:
            self.__init_candles()
    ...
    def __init_candles(self) -> None:
        ...
        while len(self._btc_strategy.candles) <= self._btc_strategy.window_size and len(
                self._eth_strategy.candles) <= self._eth_strategy.window_size:
            # -- -- BTC
